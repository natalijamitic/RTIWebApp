...
@Component({
  selector: 'display-subject-student-lab',
  templateUrl: './display-subject-student-lab.component.html',
  styleUrls: ['./display-subject-student-lab.component.scss']
})
export class DisplaySubjectStudentLabComponent implements OnInit {
