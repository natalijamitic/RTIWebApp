...
@Component({
  selector: 'display-subject-student-project',
  templateUrl: './display-subject-student-project.component.html',
  styleUrls: ['./display-subject-student-project.component.scss']
})
export class DisplaySubjectStudentProjectComponent implements OnInit {
