...
@Component({
  selector: 'display-subject-student-exercise',
  templateUrl: './display-subject-student-exercise.component.html',
  styleUrls: ['./display-subject-student-exercise.component.scss']
})
export class DisplaySubjectStudentExerciseComponent implements OnInit {
