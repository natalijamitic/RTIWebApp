...
@Component({
  selector: 'display-subject-student-exam-materials',
  templateUrl: './display-subject-student-exam-materials.component.html',
  styleUrls: ['./display-subject-student-exam-materials.component.scss']
})
export class DisplaySubjectStudentExamMaterialsComponent implements OnInit {
